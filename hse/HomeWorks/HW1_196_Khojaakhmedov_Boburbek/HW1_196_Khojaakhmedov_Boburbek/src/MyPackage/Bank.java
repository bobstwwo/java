...
public class Bank extends Field {
     ...
     * @param max max value which is can be accepted
     */
    ...
    /**
     * Checks is it possible to parse or not
     * @param value The value prom the user, to be checks for parsing to Integer
     */
